...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/SantiSparkov/dicta"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("Dicta/0.9.6 (+https://github.com/SantiSparkov/dicta)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("Dicta"));
